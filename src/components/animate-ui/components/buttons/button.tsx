...
type ButtonProperties = ButtonPrimitiveProperties & VariantProps<typeof buttonVariants>

function Button({ className, variant, size, ...properties }: ButtonProperties) {
  return (
    <ButtonPrimitive className={cn(buttonVariants({ variant, size, className }))} {...properties} />
  )
}
